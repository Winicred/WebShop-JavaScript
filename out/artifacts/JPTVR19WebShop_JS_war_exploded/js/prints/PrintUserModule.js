    ...
    printRegistration() {
        ...
        <form id="registrationForm" method="POST" enctype="multipart/form-data">
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100" type="text" id="userLogin" placeholder="Логин" required>
            </div>
            ...
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100" type="password" id="password" placeholder="Пароль" required>
            </div>
            ...
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100" type="password" id="repeatPassword" placeholder="Подтверждение пароля" required>
            </div>
            ...
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100" type="text" id="email" placeholder="E-mail" required>
            </div>
            ...
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100 phoneNumberText" maxlength="9" type="text" id="phoneNumber" placeholder="Номер телефона" required>
            </div>
            ...
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100" type="text" id="name" placeholder="Имя" required>
            </div>
            ...
            <div class="input-group flex-nowrap w-50 my-3 mx-auto">
                ...
                <input class="form-control w-100" type="text" id="lastName" placeholder="Фамилия"
                    required>
            </div>
